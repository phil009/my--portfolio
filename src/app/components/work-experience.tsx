...
const experiences = [
      ...
      },
    {
        ...
        description: [
            "Designed and developed the official company website for Brains Specialist Hospital.",
            "Built a clean, responsive portfolio site presenting the hospital's services, team, and contact details.",
            "Technologies: Next.js, TypeScript, Tailwind CSS",
        ],
    },
      {
        ...
        link: "https://nyangu.com", // Update with actual link if different
        period: "August 2025 - October 2025",
        description: [
            "Led frontend engineering team to architect and deploy Nyangu, a comprehensive real estate marketplace connecting renters, agents, hotel owners, and landlords across Nigeria.",
            "Engineered complex features including real-time scheduling systems, instant messaging platform, and secure document management infrastructure for property listings and bookings.",
            "Established frontend architecture standards and coding best practices, mentoring team members on React patterns, TypeScript conventions, and performance optimization techniques.",
            "Built scalable, mobile-responsive interfaces supporting multiple user roles (renters, landlords, agents, hotel managers) with role-based authentication and navigation.",
            "Delivered a production-ready platform integrating property search, tour scheduling, messaging, and booking workflows in a unified ecosystem.",
    ...
    },
    {
            ...
            description: [
                  "Built a cross-platform parcel delivery app using React Native and TypeScript.",
                  "Implemented real-time tracking with socket.io, map integrations, push notifications, and secure user authentication.",
                  "Assisted with backend development using Node.js, Express, and MongoDB to support order workflows, driver assignments, and user management.",
