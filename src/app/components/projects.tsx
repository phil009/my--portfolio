...
const projects: Project[] = [
    {
        ...
        name: "Nyangu",
        description:
            "Directed frontend engineering team to successfully architect and deploy the Nyangu platform, a comprehensive real estate marketplace connecting renters, agents, hotel owners, and landlords nationwide",
        imageUrl: nyangu,
        liveUrl: "https://www.nyangu.com/",
        technologies: [
            "Next.js",
            "Tailwind",
            "Shadcn",
            ...
            <div className="grid md:grid-cols-2 gap-4">
                {projects.map((project) => (
                    ...
                    >
                        ...
                        <p className="text-xs sm:text-base mb-4 text-gray-600 dark:text-gray-300">
                            {project.description}
                        </p>
